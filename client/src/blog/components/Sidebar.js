    ...
    render() {
        ...
        let courseList = this.state.Courses.map((val, i) => {
            return ( <
                li key = { i } >
                <
                a href = { `${process.env.PUBLIC_URL}/blog-left-sidebar` } > { val.courseName } <
                /a> <
                /li>
            );
        });
        ...
        let popularPostDataList = popularPostData.map((val, i) => {
            return ( <
                ...
                className = "image" >
                <
                img src = { `assets/img/blog/${val.postImage}` }
                alt = "" / >
                <
                /a> <
                ...
                h5 >
                <
                a href = { `${process.env.PUBLIC_URL}/${val.postLink}` } > { val.postTitle } <
                /a> <
                /h5> <
        ...
        return ( <
            ...
            div className = "sidebar" >
            <
            h3 className = "sidebar-title" > Popular Post < /h3> { popularPostDataList } <
            /div> <
            div className = "sidebar" >
            <
